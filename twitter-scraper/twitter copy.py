...
async def scrape_profile_tweets(url: str, limit: int = None) -> List[Dict]:
    """
    Scrapes all tweets from a given profile URL.
    :param url: URL of the Twitter profile
    :param limit: Maximum number of tweets to scrape (optional)
